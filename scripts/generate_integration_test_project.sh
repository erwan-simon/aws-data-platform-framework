...
# Derive git_repository from this repo's remote, stripping any user:token@ baked in
# (env vars like CI_PROJECT_URL can carry creds locally).
...
echo "Generated at ${OUTPUT_DIR}/datalake_test/iac"
