...
from datalake_sdk.update_foreign_linked_databases import command_line_update_foreign_linked_databases
...
@click.option(
    ...
    help="Project name")
@click.option(
    "-d", '--domain-name', required=True,
    help="Domain name")
@click.option(
    "-s", '--stage-name', required=True,
    help="Stage name")
def command_line_main(
        ctx, project_name: str, domain_name: str, stage_name: str) -> int:
...
command_line_main.add_command(command_line_update_foreign_linked_databases, "update_foreign_linked_databases")
